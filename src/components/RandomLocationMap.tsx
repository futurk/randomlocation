...
import { getRandomLocation, getDistanceInKm, formatDistance, getGoogleMapsUrl, getKomootUrl } from "./helpers";
import Map from "./Map";
import {
  Moon,
  Sun,
      ...
      <main className="flex-1 relative w-full overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 right-4 z-[999] md:hidden">
          <div className={`rounded-xl border shadow-xl p-3.5 space-y-2.5 transition-all duration-300 ${panelBg}`}>
            ...
            {/* Row 2: Dual Range Sliders for Min and Max Radius with Editable Inputs */}
